...
def main() -> int:
    ...
    from benchmarks.runners.suite import DEFAULT_RUNNABLE_FAMILIES, run_benchmark_suite
    ...
    parser.add_argument("--strategy", action="append", dest="strategies", help="Strategy to run. Defaults to ga/alns/tabu.")
    ...
    summary = run_benchmark_suite(
        ...
        strategies=tuple(args.strategies or ("ga", "alns", "tabu")),
        seed=args.seed,
