...
NUG12 = QapCase(
    ...
    tier='smoke',
    compare_key='qaplib/assignment/quadratic_assignment/nug12',
    series_key='qaplib/assignment/quadratic_assignment/nug12/sequence_var_external_call',
 ...
 'status': 'optimal',
 'value_kind': 'optimal'},
    problem_description=('QAPLIB quadratic assignment instance nug12: assign 12 facilities to 12 locations. The cost is '
 ...
 'optagent_modeling': {'constraints': ['sequence_var enforces a one-to-one facility-location '
                       ...
                       'decision_variables': ['one sequence_var assignment of size 12; '
...
NUG20 = QapCase(
    ...
    family='sequence_quadratic_assignment',
    tier='calibration',
    compare_key='qaplib/assignment/quadratic_assignment/nug20',
    series_key='qaplib/assignment/quadratic_assignment/nug20/sequence_var_external_call',
 ...
 'status': 'optimal',
 'value_kind': 'optimal'},
    problem_description=('QAPLIB quadratic assignment instance nug20: assign 20 facilities to 20 locations. The cost is '
 'the sum of flow between facility pairs multiplied by distance between assigned locations. This '
 'is a permutation blackbox benchmark with a published optimum.'),
    case_module=CASE_MODULE,
    modeling_notes={'model_style': 'sequence_var_external_call',
