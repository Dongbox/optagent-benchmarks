...
CHR12A = QapCase(
    ...
    tier='smoke',
    compare_key='qaplib/assignment/quadratic_assignment/chr12a',
    series_key='qaplib/assignment/quadratic_assignment/chr12a/sequence_var_external_call',
 ...
 'status': 'optimal',
 'value_kind': 'optimal'},
    problem_description=('QAPLIB quadratic assignment instance chr12a: assign 12 facilities to 12 locations. The cost is '
