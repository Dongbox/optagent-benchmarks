...
LA16 = JobShopCase(
    ...
    tier='calibration',
    compare_key='jsplib/scheduling/jobshop/la16',
    series_key='jsplib/scheduling/jobshop/la16/interval_var_sequence_no_overlap_precedence',
 ...
 'upper_bound': 945,
 'value_kind': 'optimal'},
    problem_description=('JSPLIB job-shop instance la16: schedule 10 jobs across 10 machines. Each job has a fixed machine '
...
LA21 = JobShopCase(
    ...
    family='interval_job_shop',
    tier='calibration',
    compare_key='jsplib/scheduling/jobshop/la21',
    series_key='jsplib/scheduling/jobshop/la21/interval_var_sequence_no_overlap_precedence',
 ...
 'upper_bound': 1046,
 'value_kind': 'optimal'},
    problem_description=('JSPLIB job-shop instance la21: schedule 15 jobs across 10 machines. Each job has a fixed machine '
 'route and fixed operation durations; each machine can process at most one operation at a time. '
 'The benchmark objective is minimum makespan.'),
    case_module=CASE_MODULE,
    modeling_notes={'model_style': 'interval_var_sequence_no_overlap_precedence',
 ...
 'optagent_modeling': {'constraints': ['builder.no_overlap(machine_order[m], '
                       ...
                       'data_mapping': 'Read ScheduleOpt JSPLIB JSON rows as operations with job, '
                                       'operation index, machine, and duration.',
                       'decision_variables': ['150 interval_var operation[j,k] with fixed duration '
                                              'and bounded start',
                                              '10 sequence_var machine_order[m], each ordering '
                                              'operations assigned to one machine'],
                       'objective': 'builder.minimize(builder.max(*(builder.interval_end(last_operation[j]) '
