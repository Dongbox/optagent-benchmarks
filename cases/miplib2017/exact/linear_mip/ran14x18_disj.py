...
RAN14X18_DISJ_8 = MipCase(
    ...
    tier='smoke',
    compare_key='miplib2017/exact/linear_mip/ran14x18-disj-8',
    series_key='miplib2017/exact/linear_mip/ran14x18-disj-8/mps_linear_mp',
    size={'binaries': 252,
 'constraints': 447,
 'continuous': 252,
 'integers': 0,
 ...
 'value_kind': 'optimal'},
    problem_description=('MIPLIB 2017 benchmark instance ran14x18-disj-8: linear mixed-integer program with 504 variables, '
 '447 constraints, and tags [benchmark, benchmark_suitable, variable_bound, set_covering, '
 'mixed_binary]. It is included as an exact MP/MPS backend benchmark rather than a primary GA/ALNS '
 'search case.'),
