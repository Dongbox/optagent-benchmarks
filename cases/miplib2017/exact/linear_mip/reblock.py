...
REBLOCK115 = MipCase(
    ...
    tier='calibration',
    compare_key='miplib2017/exact/linear_mip/reblock115',
    series_key='miplib2017/exact/linear_mip/reblock115/mps_linear_mp',
    size={'binaries': 1150,
 'constraints': 4735,
 'continuous': 0,
 'integers': 0,
 ...
 'value_kind': 'optimal'},
    problem_description=('MIPLIB 2017 benchmark instance reblock115: linear mixed-integer program with 1150 variables, '
 '4735 constraints, and tags [benchmark, binary, benchmark_suitable, precedence, knapsack]. It is '
 'included as an exact MP/MPS backend benchmark rather than a primary GA/ALNS search case.'),
