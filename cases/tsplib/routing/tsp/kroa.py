...
KROA100 = TspCase(
    ...
    family='sequence_blackbox_tsp',
    tier='calibration',
    compare_key=f"{SOURCE_KEY}/{PROBLEM_TYPE}/{INSTANCE_TYPE}/kroa100",
    series_key=f"{SOURCE_KEY}/{PROBLEM_TYPE}/{INSTANCE_TYPE}/kroa100/{MODEL_STYLE}",
    size={'nodes': 100},
 ...
 'status': 'optimal',
 'value_kind': 'optimal'},
    problem_description='TSPLIB symmetric TSP instance kroa100: find the shortest Hamiltonian cycle over 100 cities using the instance distance metric. The benchmark is a blackbox sequence optimization case with a published optimal tour length.',
 ...
 'decision_variables': ['one sequence_var tour of size 100; the sequence is the city visit order'],
