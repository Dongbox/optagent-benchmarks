...
A280 = TspCase(
    ...
    family='sequence_blackbox_tsp',
    tier='full',
    compare_key=f"{SOURCE_KEY}/{PROBLEM_TYPE}/{INSTANCE_TYPE}/a280",
    series_key=f"{SOURCE_KEY}/{PROBLEM_TYPE}/{INSTANCE_TYPE}/a280/{MODEL_STYLE}",
    size={'nodes': 280},
 ...
 'status': 'optimal',
 'value_kind': 'optimal'},
    problem_description='TSPLIB symmetric TSP instance a280: find the shortest Hamiltonian cycle over 280 cities using the instance distance metric. The benchmark is a blackbox sequence optimization case with a published optimal tour length.',
 ...
 'decision_variables': ['one sequence_var tour of size 280; the sequence is the city visit order'],
