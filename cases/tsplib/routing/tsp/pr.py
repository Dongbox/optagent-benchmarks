...
PR76 = TspCase(
    ...
    family='sequence_blackbox_tsp',
    tier='calibration',
    compare_key=f"{SOURCE_KEY}/{PROBLEM_TYPE}/{INSTANCE_TYPE}/pr76",
    series_key=f"{SOURCE_KEY}/{PROBLEM_TYPE}/{INSTANCE_TYPE}/pr76/{MODEL_STYLE}",
    size={'nodes': 76},
    data={'instance_url': 'https://comopt.ifi.uni-heidelberg.de/software/TSPLIB95/tsp/pr76.tsp.gz',
 ...
 'status': 'optimal',
 'value_kind': 'optimal'},
    problem_description='TSPLIB symmetric TSP instance pr76: find the shortest Hamiltonian cycle over 76 cities using the instance distance metric. The benchmark is a blackbox sequence optimization case with a published optimal tour length.',
 ...
 'decision_variables': ['one sequence_var tour of size 76; the sequence is the city visit order'],
