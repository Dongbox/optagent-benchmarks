...
PR76 = TspCase(
    ...
    tier='calibration',
    compare_key='tsplib/routing/tsp/pr76',
    series_key='tsplib/routing/tsp/pr76/sequence_var_external_call',
    size={'nodes': 76},
 ...
 'status': 'optimal',
 'value_kind': 'optimal'},
    problem_description=('TSPLIB symmetric TSP instance pr76: find the shortest Hamiltonian cycle over 76 cities using the '
 'instance distance metric. The benchmark is a blackbox sequence optimization case with a '
 ...
 'optagent_modeling': {'constraints': ['sequence_var represents a permutation, so no separate '
                       ...
                       'data_mapping': 'Read TSPLIB coordinates or explicit distances and '
                                       ...
                                       'callback.',
                       'decision_variables': ['one sequence_var tour of size 76; the sequence is '
