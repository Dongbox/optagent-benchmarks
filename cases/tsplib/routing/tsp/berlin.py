...
BERLIN52 = TspCase(
    ...
    family='sequence_blackbox_tsp',
    tier='smoke',
    compare_key=f"{SOURCE_KEY}/{PROBLEM_TYPE}/{INSTANCE_TYPE}/berlin52",
    series_key=f"{SOURCE_KEY}/{PROBLEM_TYPE}/{INSTANCE_TYPE}/berlin52/{MODEL_STYLE}",
    size={'nodes': 52},
    data={'instance_url': 'https://comopt.ifi.uni-heidelberg.de/software/TSPLIB95/tsp/berlin52.tsp.gz',
 ...
 'status': 'optimal',
 'value_kind': 'optimal'},
    problem_description='TSPLIB symmetric TSP instance berlin52: find the shortest Hamiltonian cycle over 52 cities using the instance distance metric. The benchmark is a blackbox sequence optimization case with a published optimal tour length.',
 ...
 'decision_variables': ['one sequence_var tour of size 52; the sequence is the city visit order'],
