...
BERLIN52 = TspCase(
    ...
    tier='smoke',
    compare_key='tsplib/routing/tsp/berlin52',
    series_key='tsplib/routing/tsp/berlin52/sequence_var_external_call',
    size={'nodes': 52},
 ...
 'status': 'optimal',
 'value_kind': 'optimal'},
    problem_description=('TSPLIB symmetric TSP instance berlin52: find the shortest Hamiltonian cycle over 52 cities using '
 ...
 'optagent_modeling': {'constraints': ['sequence_var represents a permutation, so no separate '
                       ...
                       'data_mapping': 'Read TSPLIB coordinates or explicit distances and '
                                       ...
                                       'callback.',
                       'decision_variables': ['one sequence_var tour of size 52; the sequence is '
