...
EIL51 = TspCase(
    ...
    tier='smoke',
    compare_key='tsplib/routing/tsp/eil51',
    series_key='tsplib/routing/tsp/eil51/sequence_var_external_call',
    size={'nodes': 51},
 ...
 'status': 'optimal',
 'value_kind': 'optimal'},
    problem_description=('TSPLIB symmetric TSP instance eil51: find the shortest Hamiltonian cycle over 51 cities using '
 ...
 'optagent_modeling': {'constraints': ['sequence_var represents a permutation, so no separate '
                       ...
                       'data_mapping': 'Read TSPLIB coordinates or explicit distances and '
                                       ...
                                       'callback.',
                       'decision_variables': ['one sequence_var tour of size 51; the sequence is '
