...
J90_5_3 = RcpspCase(
    ...
    family='cumulative_resource_scheduling',
    tier='full',
    compare_key=f"{SOURCE_KEY}/{PROBLEM_TYPE}/{INSTANCE_TYPE}/j90_5_3",
    series_key=f"{SOURCE_KEY}/{PROBLEM_TYPE}/{INSTANCE_TYPE}/j90_5_3/{MODEL_STYLE}",
 ...
 'status': 'open_bound_gap',
 'upper_bound': 87,
 'value_kind': 'best_known'},
    problem_description='PSPLIB RCPSP instance j90_5_3: schedule 90 project activities with precedence constraints and four renewable resources. The objective is minimum project makespan; this selected case has public lower and upper bounds but is not closed in the public reference file.',
