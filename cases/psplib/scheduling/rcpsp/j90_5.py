...
J90_5_3 = RcpspCase(
    ...
    tier='full',
    compare_key='psplib/scheduling/rcpsp/j90_5_3',
    series_key='psplib/scheduling/rcpsp/j90_5_3/interval_var_cumulative_precedence',
 ...
 'value_kind': 'best_known'},
    problem_description=('PSPLIB RCPSP instance j90_5_3: schedule 90 project activities with precedence constraints and '
 'four renewable resources. The objective is minimum project makespan; this selected case has '
 'public lower and upper bounds but is not closed in the public reference file.'),
