...
RCPSP_CPSAT = StrategyDeclaration("cpsat", "CpSatConfig", "cpsat_scheduling_exact_v1", kind="exact_baseline", config={"time_limit_s": DEFAULT_TIME_LIMIT_S, "workers": DEFAULT_THREAD_COUNT, "random_seed": DEFAULT_SEED, "log_to_stdout": False, "enable_solution_callback": True, "solution_event_limit": DEFAULT_TRACE_LIMIT})
...
DEFAULT_STRATEGIES = (RCPSP_CPSAT, RCPSP_GA, RCPSP_ALNS)
...
J90_6_7 = RcpspCase(
    ...
    family='cumulative_resource_scheduling',
    tier='full',
    compare_key=f"{SOURCE_KEY}/{PROBLEM_TYPE}/{INSTANCE_TYPE}/j90_6_7",
    series_key=f"{SOURCE_KEY}/{PROBLEM_TYPE}/{INSTANCE_TYPE}/j90_6_7/{MODEL_STYLE}",
 ...
 'instance_url': 'https://raw.githubusercontent.com/ScheduleOpt/benchmarks/main/rcpsp/instances/j90/j90_6_7.rcp'},
    reference={'lower_bound': 71,
 ...
 'upper_bound': 71,
 'value_kind': 'optimal'},
    problem_description='PSPLIB RCPSP instance j90_6_7: schedule 90 project activities with precedence constraints and four renewable resources. The objective is minimum project makespan; this selected case has a verified optimum.',
 ...
 'primary_route': 'solve_cpsat for exact/bounds on closed cases; solve(..., '
...
def solve_case(
    ...
    *,
    ...
    if include_exact_baseline:
        rows.append(_run_cpsat_baseline(case=case, model=model, budget=effective_budget))
