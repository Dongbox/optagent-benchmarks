...
- `python -m benchmarks.run --case jsplib_ft06 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
- `python -m benchmarks.run --case jsplib_la16 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
- `python -m benchmarks.run --case jsplib_dmu01 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
- `python -m benchmarks.run --case jsplib_swv01 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
- `python -m benchmarks.run --case psplib_j90_1_1 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
- `python -m benchmarks.run --case tsplib_berlin52 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
- `python -m benchmarks.run --case qaplib_nug12 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
...
- `python -m compileall benchmarks/cases`
- `python -m benchmarks.run --list-cases`
- `python -m benchmarks.run --case jsplib_abz5 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
- `python -m benchmarks.run --case jsplib_abz7 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
- `python -m benchmarks.run --case jsplib_ft06 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
- `python -m benchmarks.run --case jsplib_ft10 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
- `python -m benchmarks.run --case jsplib_la16 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
- `python -m benchmarks.run --case jsplib_la21 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
- `python -m benchmarks.run --case jsplib_dmu01 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
- `python -m benchmarks.run --case jsplib_swv01 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
- `python -m benchmarks.run --case psplib_j90_1_1 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
- `python -m benchmarks.run --case tsplib_berlin52 --strategy ga --no-download --max-iterations 1 --population-size 4 --time-limit-s 0.1`
